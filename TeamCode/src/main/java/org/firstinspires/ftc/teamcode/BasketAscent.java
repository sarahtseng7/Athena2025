...
@Autonomous(name="BasketAscent", group="Pushbot")
//@Disabled
public class BasketAscent extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(300);
        drive(11.53);
        robot.claw2.setPosition(1.00);
        robot.arm.setPosition(1.0);
        sleep(1100);
        robot.claw2.setPosition(0.85);
        sleep(500);
    ...
    */
    ...
    public void vSlide(double speed, double inches) {
        ...
        if (opModeIsActive()) {
            ...
            vSlideInches = robot.vSlideMotor.getCurrentPosition() + (int) (-inches * 104.92);
